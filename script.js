  ...
  const mutationObserver = new MutationObserver(function (mutations) {
    mutations.forEach(function (mutation) {
      mutation.addedNodes.forEach(function (node) {
        ...
        if (node.matches && node.matches(OBSERVE_SELECTOR)) {
          const navbarEl = document.querySelector('.navbar, nav, header');
          const navbarHeight = navbarEl ? navbarEl.offsetHeight : 0;
          const rect = node.getBoundingClientRect();
          const isVisible = rect.top < window.innerHeight - navbarHeight;
        ...
        const nestedEls = node.querySelectorAll ? node.querySelectorAll(OBSERVE_SELECTOR) : [];
        nestedEls.forEach(function (el) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Watchful Eye - Retail Security משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '61daf70f-3e1c-48f1-9249-70a399e5eb24',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '61daf70f-3e1c-48f1-9249-70a399e5eb24';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '61daf70f-3e1c-48f1-9249-70a399e5eb24';
